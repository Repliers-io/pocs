 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]],H=o("search",Q);function A({apiKey:P,placeholder:k="Search for properties..."}){const I=P||"9F9oOgiUJylmCyRFzb8YkfLOpdcwkp",[a,_]=l.useState(""),[p,u]=l.useState([]),[n,x]=l.useState(!1),[h,i]=l.useState(!1),[d,c]=l.useState(null);l.useEffect(()=>{if(!a.trim()){u([]),c(null),i(!1);return}if(a.trim().length<3){u([]),c(null),i(!1);return}i(!0),c(null);const s=setTimeout(async()=>{i(!1),await E(a.trim())},400);return()=>{clearTimeout(s),i(!1)}},[a]);const E=async s=>{x(!0),c(null);try{const t=await fetch(`https://dev.repliers.io/listings?search=${encodeURIComponent(s)}&searchFields=address.streetNumber,address.streetName,mlsNumber,address.city&fields=address.*,mlsNumber,listPrice,details.numBedrooms,details.numBedroomsPlus,details.numBathrooms,details.numBathroomsPlus,details.numGarageSpaces,details.propertyType,status,images&fuzzysearch=true`,{headers:{"REPLIERS-API-KEY":I,"Content-Type":"application/json"}});if(!t.ok)throw t.status===401?new Error("Invalid API key. Please check your Repliers API key."):t.status===403?new Error("API key doesn't have permission for this endpoint."):t.status===429?new Error("Too many requests. Please wait a moment and try again."):new Error(`API Error: ${t.status}`);const r=await t.json();u(r.listings||[])}catch(t){console.error("Search error:",t);const r=t instanceof Error?t.message:"Failed to search. Please try again.";c(r)}finally{x(!1)}},T=s=>new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:0,maximumFractionDigits:0}).format(s),R=s=>{if(!s)return"N/A";const t=s.numBedrooms,r=s.numBedroomsPlus;return t&&r&&r>0?`${t} + ${r}`:(t==null?void 0:t.toString())||"N/A"},L=s=>{if(!s)return"N/A";const t=s.numBathrooms,r=s.numBathroomsPlus;return t&&r&&r>0?`${t} + ${r}`:(t==null?void 0:t.toString())||"N/A"},M=s=>{var t;return s&&((t=s.numGarageSpaces)==null?void 0:t.toString())||"N/A"},$=s=>s?{A:"For Sale",Active:"For Sale",S:"Sold",Sold:"Sold",L:"Leased",Lease:"Leased",Leased:"Leased",T:"Terminated",Terminated:"Terminated",Expired:"Terminated",Cancelled:"Terminated"}[s]||s:null,q=({status:s})=>{const t=$(s);if(!t)return null;let r="bg-green-100 text-green-600";return t==="Sold"?r="bg-blue-100 text-blue-600":t==="Leased"?r="bg-purple-100 text-purple-600":t==="Terminated"&&(r="bg-gray-100 text-gray-500"),e.jsx("span",{className:`text-xs px-2 py-1 rounded-md font-medium ${r}`,children:t})},y=p.length>0,B=a.trim()&&(y||n||h||d||a.trim().length>=3);return e.jsx("div",{className:"flex",children:e.jsx("div",{className:"relative flex items-center justify-end gap-1 py-0 lg:py-4",children:e.jsx("div",{className:"flex-1 duration-400 transition-[min-width] delay-100 ease-in min-w-[600px]",children:e.jsx("div",{className:"p-6 flex flex-col items-center w-full",children:e.jsxs("div",{className:"relative flex items-center bg-gray-100 rounded-md px-4 py-2 w-full",children:[e.jsx(H,{className:"text-gray-400 w-5 h-5 mr-3"}),e.jsx("input",{type:"text",value:a,onChange:s=>_(s.target.value),placeholder:k,className:"flex-grow bg-transparent outline-none text-gray-700 placeholder-gray-500"}),n&&e.jsx(J,{className:"w-4 h-4 animate-spin text-gray-400 mr-2"}),e.jsx("span",{className:"text-gray-800 font-semibold text-sm px-2",children:"Search"}),B&&e.jsx("div",{className:"absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-lg z-50",children:e.jsxs("div",{className:"max-h-[500px] overflow-y-auto p-4 space-y-4",children:[d&&e.jsxs("div",{className:"flex items-center gap-2 text-red-600 mb-4",children:[e.jsx(G,{className:"w-4 h-4"}),e.jsx("span",{className:"text-sm",children:d})]}),n&&e.jsx("div",{className:"space-y-4",children:[...Array(3)].map((s,t)=>e.jsxs("div",{className:"flex items-center gap-4 animate-pulse",children:[e.jsx("div",{className:"w-24 h-16 bg-gray-200 rounded-md"}),e.jsxs("div",{className:"flex-grow",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsx("div",{className:"h-6 bg-gray-200 rounded w-32"}),e.jsx("div",{className:"h-5 bg-gray-200 rounded w-16"})]}),e.jsx("div",{className:"h-4 bg-gray-200 rounded w-3/4 mb-2"}),e.jsxs("div",{className:"flex space-x-3",children:[e.jsx("div",{className:"h-4 bg-gray-200 rounded w-20"}),e.jsx("div",{className:"h-4 bg-gray-200 rounded w-16"}),e.jsx("div",{className:"h-4 bg-gray-200 rounded w-18"})]})]})]},t))}),h&&!n&&e.jsx("div",{className:"space-y-4",children:[...Array(2)].map((s,t)=>e.jsxs("div",{className:"flex items-center gap-4 animate-pulse",children:[e.jsx("div",{className:"w-24 h-16 bg-gray-100 rounded-md"}),e.jsxs("div",{className:"flex-grow",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsx("div",{className:"h-6 bg-gray-100 rounded w-32"}),e.jsx("div",{className:"h-5 bg-gray-100 rounded w-16"})]}),e.jsx("div",{className:"h-4 bg-gray-100 rounded w-3/4 mb-2"}),e.jsxs("div",{className:"flex space-x-3",children:[e.jsx("div",{className:"h-4 bg-gray-100 rounded w-20"}),e.jsx("div",{className:"h-4 bg-gray-100 rounded w-16"}),e.jsx("div",{className:"h-4 bg-gray-100 rounded w-18"})]})]})]},t))}),!n&&!h&&!d&&!y&&a.trim()&&e.jsxs("div",{className:"text-center py-8",children:[e.jsx(O,{className:"w-16 h-16 text-gray-400 mx-auto mb-3"}),e.jsx("h3",{className:"text-lg font-semibold text-gray-700 mb-2",children:"No results found"}),e.jsx("p",{className:"text-gray-500 mb-2",children:"There aren't any search results that match your query."}),e.jsx("p",{className:"text-gray-500",children:"Try searching for a different property."})]}),!n&&p.length>0&&e.jsx(e.Fragment,{children:p.map((s,t)=>{var r,f,g,N,j,v;return e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-24 h-16 bg-gray-100 rounded-md overflow-hidden",children:(r=s.images)!=null&&r[0]?e.jsx("img",{src:`https://cdn.repliers.io/${s.images[0]}?class=small`,alt:"Property",className:"object-cover w-full h-full"}):e.jsx("div",{className:"flex items-center justify-center h-full text-xs text-gray-400",children:"No Image"})}),e.jsxs("div",{className:"flex-grow",children:[e.jsxs("div",{className:"flex justify-between items-start",children:[e.jsx("h3",{className:"font-semibold text-base",children:s.listPrice?T(s.listPrice):"Price N/A"}),e.jsx(q,{status:s.status})]}),e.jsxs("p",{className:"text-xs text-gray-600",children:[`${((f=s.address)==null?void 0:f.streetNumber)||""} ${((g=s.address)==null?void 0:g.streetName)||""} ${((N=s.address)==null?void 0:N.streetSuffix)||""}, ${((j=s.address)==null?void 0:j.city)||""}`," ","| ",s.mlsNumber]}),e.jsxs("div",{className:"flex items-center text-xs text-gray-500 mt-1 space-x-3 flex-wrap",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(z,{className:"w-4 h-4"}),R(s.details)," Bedroom"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(F,{className:"w-4 h-4"}),L(s.details)," Bath"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(K,{className:"w-4 h-4"}),M(s.details)," Garage"]}),((v=s.details)==null?void 0:v.propertyType)&&e.jsxs("span",{children:["| ",s.details.propertyType]})]})]})]},s.mlsNumber||t)})})]})})]})})})})})}A.__docgenInfo={description:`AutocompleteSearch Component
