...
<Meta title="Blog & Writing/The AI Search Input" />

# The AI Search Input

**January 6-14, 2026** · 7 min read
...
Then search automatically. No chat. No back-and-forth. The approach felt straightforward.
...
It looked polished. It felt futuristic. Then I watched people actually use it.
...
- Chips appear: 🛏️ 3 beds | 🏠 Condo | 📍 Liberty Village
...
## January 14th: Another Approach

Something felt off. I'd invested a week in the entity chips approach. Maybe the issue was the presentation?
...
2. Had no spatial context (where *is* Liberty Village?)
...
I created a rough proof-of-concept combining the AI input with a map. Something clicked:

**The map was the interface.** Not the search box.

Users wanted to:
- See *where* properties are
- Explore *visually*
- Refine *spatially*

The search box should *enhance* the map, not replace it.

---

## January 29th: The Commit

When I committed the hybrid map-listings component, the diff told the story:
...
The code cleared. The path forward became visible.

---

## What I Learned

### 1. Better Presentation Doesn't Fix a Mismatch in Interface

I tried two major refactors:
- January 8th: Make it complete and robust
- January 14th: Make it subtle and elegant

Both focused on presentation. The deeper question was whether text-based search matched the spatial, exploratory nature of finding a home.

### 2. When You're Fighting the UI, Listen

When I wrote *"AI feels naturally integrated, not bolted on"* in my commit message, I was working hard to justify the approach.

If integration feels forced, that's signal worth paying attention to.
...
But Repliers NLP *already does entity extraction*. I was adding complexity for no benefit.
...
The hybrid map I built next was informed by this exploration.
...
**Next**: Week 3: Finding the Hybrid - NLP-Powered Map Search →
